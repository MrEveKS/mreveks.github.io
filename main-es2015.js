...
let TextSearchDirective = class TextSearchDirective {
    constructor(elementRef) {
        this.elementRef = elementRef;
        this.instance = new mark_js__WEBPACK_IMPORTED_MODULE_3___default.a(this.elementRef.nativeElement);
    }
    ngOnInit() {
        this.findEmmit.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(250), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["distinctUntilChanged"])()).subscribe((v) => {
            this.instance.unmark().mark(v);
        });
    }
};
TextSearchDirective.ctorParameters = () => [
